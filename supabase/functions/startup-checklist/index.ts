...
serve(async (req) => {
  ...
  try {
    ...
    // Validate input
    const validation = startupChecklistSchema.safeParse(rawBody);
    ...
    const { businessType, industry, location, fundingGoal, timeline, hasCofounder } = validation.data;
