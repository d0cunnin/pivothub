                  ...
                  <Tabs defaultValue="proposal" className="w-full">
                    ...
                    <TabsContent value="proposal" className="space-y-4">
                      <div className="flex justify-between items-center">
                        <h3 className="text-lg font-semibold">Grant Proposal</h3>
                        <Button
                          variant="outline"
                          size="sm"
                    ...
                    <TabsContent value="loi" className="space-y-4">
                      <div className="flex justify-between items-center">
                        <h3 className="text-lg font-semibold">Letter of Intent</h3>
                        <Button
                          variant="outline"
                          size="sm"
                      ...
                      <div className="bg-muted p-4 rounded-lg">
                        <pre className="whitespace-pre-wrap text-sm">{generatedLOI}</pre>
                      </div>
                    </TabsContent>
                  </Tabs>
                </CardContent>
