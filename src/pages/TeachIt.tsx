...
const TeachIt = () => {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <Button 
                ...
                onClick={() => document.getElementById('course-tools')?.scrollIntoView({ behavior: 'smooth' })}
              >
      ...
      <section id="course-tools" className="section-spacing-sm bg-gradient-section-2 relative overflow-hidden">
        <div className="page-container">
          <div className="text-center mb-12">
            <div className="inline-block p-6 bg-gradient-card rounded-2xl shadow-elegant backdrop-blur-sm mb-4">
              <h2 className="text-3xl md:text-4xl font-bold bg-gradient-hero bg-clip-text text-transparent">
            ...
            <p className="text-lg text-foreground/80">
              Everything you need to create professional courses and webinars
            </p>
          </div>
