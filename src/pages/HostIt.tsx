  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta
          name="description"
          content="Coordinate in-person, virtual, or hybrid events with complete planning for logistics, tech, speakers, sponsors, and promotion."
        />
      </Helmet>
      ...
      <section className="py-20 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <p
              className="text-xl md:text-2xl lg:text-3xl text-white/90 mb-10 font-light leading-relaxed animate-fade-in max-w-4xl mx-auto"
              style={{ animationDelay: "0.2s" }}
            >
              From Idea to Execution & Sponsorship: Your Complete Event Playbook.
            </p>
